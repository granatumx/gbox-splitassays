!bquote
`gbox-mergedropclusters` is a gbox that provides an ability to merge/drop clusters 
!equote
...
$ gx installGbox.sh granatumx/gbox-mergedropclusters:1.0.0  # Install this gbox
